...
export function IdPSelectLanguages() {
  ...
  this.langBundles = {
    'en' : {
      ...
      'submitButton.title' : 'Continue with selected organization',
      'helpText' : 'Help',
    ...
    'de' : {
      ...
      'idpList.label' :
          'Oder w\u00e4hlen Sie Ihre Institution aus einer Liste:',
      'idpList.NoPreferred.label' :
    ...
    'pt-br' : {
      ...
      'idpList.showList' :
          'Permitir que eu escolha um IdP através de uma lista',
